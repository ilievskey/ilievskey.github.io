...
//     }
// });
// tlSkills.fromTo("#skillsList div", {y: "65%"}, {y: "-37%", ease: "none"});
...
ScrollTrigger.matchMedia({
    "(min-width: 769px)": function() {
        ...
        tlSkills.fromTo("#skillsList div", {y: "65%"}, {y: "-40%", ease: "none"});
    },
    "(max-width: 768px)": function() {
        ...
        tlSkills.fromTo("#skillsList div", {y: "75%"}, {y: "-40%", ease: "none"});
    }
});
...
// .fromTo("#interBg", {fontSize: "0vw", letterSpacing: "2em"}, {fontSize: "32vw", letterSpacing: "0em"})
